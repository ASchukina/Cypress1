describe("Тестирование логина", () => {
    ...
    describe("Тестирование добавления в избранное", () => {
        ...
        it("Добавление любимой книги", () => {
            cy.addBook("Что такое тестирование. Курс молодого бойца", "Книга для новичков", "Ольга Назина");
            cy.contains("Ольга Назина").should("be.visible");
        });
    
        it("Добавление книги в любимое из списка", () => {
            cy.addBookWithFavourite("Что такое тестирование. Курс молодого бойца", "Книга для новичков", "Ольга Назина");
            cy.get("h4").click();
            cy.contains("Что такое тестирование. Курс молодого бойца").should("be.visible");
          });
          ...
          it("Удаление книги из любимых", () => {
            ...
            cy.contains("Что такое тестирование. Курс молодого бойца").should("not.exist");
          });
